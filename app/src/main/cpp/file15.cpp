...
Java_com_dream_live_cricket_score_hd_streaming_ui_activities_HomeScreen_getStringArray15(JNIEnv *env,
                                                                                   jobject thiz) {
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_com_dream_live_cricket_score_hd_tv_activities_TvMainActivity_getStringArray15(JNIEnv *env,
                                                                              jobject thiz) {
    jobjectArray strarr = env->NewObjectArray(10, env->FindClass("java/lang/String"), nullptr);
    std::string qXd = "LXwnqfvcF0JB4DONd53aTiReYFjKwTdGND!NrBG&";
    env->SetObjectArrayElement(strarr, 0, env->NewStringUTF(qXd.c_str()));
